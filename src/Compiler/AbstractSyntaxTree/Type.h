...
public:
    ...
    using MidoriTypeUnion = std::variant<UndecidedType, FloatType, IntegerType, TextType, BoolType, UnitType, NeverType, ArrayType, FunctionType, StructType, UnionType>;
